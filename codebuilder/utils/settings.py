...
LOG_INTERVAL = util.Argument(
    '--log_interval', dest='log_interval', type=int, default=LOG_INTERVAL
)
LOG_INTERVAL_UNIT = util.Argument(
    '--log_interval_unit', dest='log_interval_unit',
    choices=['h', 'm', 'd'], default=LOG_INTERVAL_UNIT
)
LOG_FORMAT = util.Argument(
    '--log_format', dest='log_format', default=LOG_FORMAT
)
LOG_BACKUPS = util.Argument(
    '--log_backups', dest='log_backups', type=int, default=LOG_BACKUPS
)
LOG_FILTERS = util.Argument(
    '--log_filters', dest='log_filters', nargs='*', default=LOG_FILTERS
)
